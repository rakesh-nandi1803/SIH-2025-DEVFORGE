      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between py-3">
          <div className="flex items-center space-x-4 flex-1">
            ...
            <div className="hidden sm:block">
              <Button 
                variant="secondary" 
                size="sm" 
                className="bg-white/20 hover:bg-white/30 text-white border-white/30 font-semibold transition-all duration-300 transform hover:scale-105"
              >
                {notification.action}
              </Button>
            </div>
          ...
          <button
            ...
            className="flex items-center justify-center w-8 h-8 bg-white/20 hover:bg-white/30 rounded-full transition-colors duration-200 group"
        ...
        <div className="sm:hidden pb-2">
          <Button 
            variant="secondary" 
            size="sm" 
            className="w-full bg-white/20 hover:bg-white/30 text-white border-white/30 font-semibold"
          >
            {notification.action}
          </Button>
        </div>
